 ...
 * Layout: 2 top, 2 bottom, 3 right (7 total frames)
 */
export const galleryFrames = [
  { x: 3, y: 0.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },   // Top wall left
  { x: 6, y: 0.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },   // Top wall right
  { x: 3, y: 4.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },   // Bottom wall left
  { x: 6, y: 4.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },   // Bottom wall right
  { x: 9.5, y: 0.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' }, // Right wall top
  { x: 9.5, y: 4.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' }, // Right wall bottom
  { x: 10.5, y: 2.5, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' }, // Right wall center
];
